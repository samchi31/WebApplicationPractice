	...
	<form method="post" enctype="multipart/form-data">
		<table>
			...
			<tr>
				<th>상품분류</th>
				<td>
<%-- 					<input class="form-control" type="text"  name="prodLgu" value="${prod.prodLgu}" /> --%>
					<select name="prodLgu">
			...
			<tr>
				<th>거래처</th>
				<td>
<%-- 					<input class="form-control" type="text"  name="prodBuyer" value="${prod.prodBuyer}" /> --%>
					<select name="prodBuyer">
						<option value>거래처</option>
						<!-- <option value="P10101" class="P101">삼성컴퓨터</option> -->
