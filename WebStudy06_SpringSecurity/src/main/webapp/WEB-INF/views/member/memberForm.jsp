...
<!-- 					<input type="file" class="form-control" name="memImage" accept="image/*" /> -->
					<form:input type="file" path="memImage" cssClass="form-control"/>
