...
// 	console.log(greetingArea.data("key2"));
	...
	let select = $('#selName').on('change',function(){
		let option = $(this).find('option:selected');
		//console.log(option.html());
// 		greetingArea.data("key1",option.html());
		greetingArea.attr("data-key1",option.html());
...
// 		console.log(greetingArea.attr("data-key1"),greetingArea.data("key1"));
		if(locale){
