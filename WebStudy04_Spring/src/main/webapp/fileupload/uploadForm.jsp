...
<form method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath }/file/upload.do">
	<ul>
		<li> 문자 데이터 : <input type="text" name="textPart"/> </li>
		<li> 숫자(?) 데이터 : <input type="number" name="numPart"/> </li>
		<li> 날짜(?) 데이터 : <input type="date" name="datePart"/> </li>
		<li> 파일 데이터 : <input type="file" name="filePart1" accept="image/*"/> </li>
		<li> 파일 데이터 : <input type="file" name="filePart2"/> </li>
